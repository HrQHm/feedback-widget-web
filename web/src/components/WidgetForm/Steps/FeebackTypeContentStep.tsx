...
export function FeedbackTypeContentStep({ 
  ...
  return (
    <>
      <header>
        <button 
          className="top-4 left-4 absolute text-zinc-400 hover:text-zinc-100" title="Fechar formulário"
          onClick={onFeedbackRestartRequest}
        >
          <ArrowLeft weight="bold" className="w-4 h-4"/>
        </button>

        <span className="text-xl leading-6 tailwind-zinc-100 flex items-center gap-2">
